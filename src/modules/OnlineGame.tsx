...
export const OnlineGame: React.FC<{ autoJoinRoom?: string | null }> = ({ autoJoinRoom }) => {
  const {
    connectionStatus,
    inGame,
    roomCode,
  ...
  /** 自动加入房间（通过分享链接）
   *  房间号格式：C-XXXXXX（8位，带前缀）或 XXXXXX（6位，兼容旧链接）
   */
  useEffect(() => {
